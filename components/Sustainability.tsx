...
const Sustainability: React.FC = () => {
  ...
  return (
    <section className="relative w-full flex flex-col lg:block bg-white overflow-hidden">
      ...
      {/* Constraints: absolute overlay, but content centered to grid */}
      <div className="w-full lg:absolute lg:inset-0 lg:z-20 lg:flex lg:items-center lg:justify-center lg:px-16 py-16 lg:py-0 pointer-events-none">

        {/* Max Width Wrapper matches global site grid */}
        <div className="w-full px-6 lg:px-16 max-w-[1440px] flex justify-end pointer-events-auto">
